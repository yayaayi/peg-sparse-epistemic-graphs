    ...
    for i, agent in enumerate(env.agent_iter()):
        ...
        if agent == predators[-1]:
            ...
            if step_count > window:
                # seuil local : le mecanisme PEG reste inchange (Definition 4),
                # seul le calibrage est adapte au taux de marquage passif de
                # cet environnement tiers
                tau_local = -np.log(1 - p0_hat) * 1.5
